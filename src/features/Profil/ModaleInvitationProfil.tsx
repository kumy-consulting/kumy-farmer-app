...
export const ModaleInvitationProfil: FunctionComponent<ModaleInvitationProfilProps> = ({
  ...
  // `prefers-reduced-motion` respecté (spec, §Écrans) : neutralise l'ouverture/
  // fermeture animée du `Dialog`, sans toucher aux transitions `filter` des
  // boutons, qui suivent déjà la même préférence via leur propre media query.
